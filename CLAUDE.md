...
<!-- maintainer note: this is the Claude Code mirror of the former .github/copilot-instructions.md.
     Keep it in sync with docs/project/ and docs/control/. Claude Code reads CLAUDE.md, not AGENTS.md,
...
4. Consult the matching canonical doc under `docs/project/` or `docs/control/` when the task changes
   package boundaries, naming, public runtime contracts, or ROS2-native development decisions.
...
The files under `.claude/rules/` are concise Claude-Code-native mirrors of the current stable docs
under `docs/project/` and `docs/control/`.
