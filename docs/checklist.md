...
- a recovery that does run still transmits nothing afterwards and never sees the arm come back (`open_questions.md`); it is off the path once the hold is recognised, but unresolved
