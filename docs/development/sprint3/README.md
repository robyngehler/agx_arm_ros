...
It captures arm-only MoveIt and MIT-controller validation work that can proceed without a live OmniHand backend, while Sprint 2 remains responsible for the shared hand runtime contract, backend bring-up, and runtime validation.
