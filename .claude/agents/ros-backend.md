---
name: ros-backend
description: ROS2 backend specialist for agx_arm_ros. Use for Python and C++ backend work such as messages, nodes, launch wiring, runtime-safe refactors, and package-scoped validation while preserving package boundaries and current Sprint 2 runtime contracts.
...
- Prefer package-scoped validation while iterating (`colcon build --packages-select ...`).
