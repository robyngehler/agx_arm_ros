...
*Use when deciding whether a file in agx_arm_ros is canonical source, generated output, or a promoted
artifact that should move into a stable source-managed location.*

Keep current-baseline changes grounded in source-managed files and avoid treating runtime outputs as
canonical input.
