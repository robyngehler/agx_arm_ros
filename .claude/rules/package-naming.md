...
Do not create additional description packages beyond `agx_arm_description` and the documented
`duo_body_description` staging surface unless a new long-term boundary is explicitly promoted into
`docs/project/`.
