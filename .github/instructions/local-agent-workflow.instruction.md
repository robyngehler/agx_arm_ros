---
description: "Use when planning and sequencing work in agx_arm_ros. Covers the preferred change order, docs promotion flow, and validation expectations for the current Duo baseline."
---
